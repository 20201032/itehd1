...
<html lang="en">
  <head>
    ...
    <div style="height: 50px; background-color: #80da62; display:flex; align-items:center;">
            <h6 style="border-radius: 25px; padding: 5px;color:white;background-color:#80da62;width:8%; margin-top:5px;"id="cookie"><?= $cookie; ?></h6>
            <div class="col-lg-6 offset-lg-3 text-center">
                <button id="btn-dodaj" type="button" class="btn btn-success" style="background-color: #80da62; border: 1px #80da62;" data-toggle="modal" data-target="#myModal-D">Dodaj meč</button>
                <button id="btn-izmeni" type="button" class="btn btn-success" style="background-color: #80da62; border: 1px #80da62;" data-toggle="modal" data-target="#myModal-I">Izmeni meč</button>
                <button id="btn-obrisi" type="button" class="btn btn-success" style="background-color: #80da62; border: 1px #80da62;" data-toggle="modal" data-target="#myModal-O">Obrisi meč</button>
            </div>
    </div>
        <section class="section" id="pretraga" style="padding-top: 100px">
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-4 text-center">
                        <div class="section-heading">
                            <h2 style="color: white; text-shadow: 3px 5px grey; font-size: 40px">Teniski mečevi</h2>
                            <h5 id="info"></h5>
                            <br><br>
                        </div>
                    </div>
            ...
            <div class="row" style="width:50%; margin:auto; margin-top: 2%">
            ...
            <br><br>
            <div class="col-lg-4 offset-lg-4 text-center">
                <button class="btn btn-primary" style="background-color: #80da62; border: 1px #80da62;" onclick="pretraga()">Pretraži</button>
            </div>
            
            <div class="row" id="rezultat" style="padding-top: 10px; width: 90%; margin-top: 5%; margin-left: 5%;"></div>
        </section>
...
<!------------------ DODAJ -------------------------------->
                ...
                <div class="modal-body">
                    <div class="container form">
                        <form action="#" method="post" id="dodajForm">
                            <h2 style="color: black; text-align: center; width: 500px;">Dodaj mec</h2>
                            <div class="row" style="color: black;">
                                ...
                                <div class="col-md-4">
                                    <br>
                                    <button id="btnDodaj" type="button" class="btn btn-success btn-block" style="background-color: #80da62; border: 1px #80da62;" onclick="dodajMec()">Dodaj</button>
                                    <br><br>
                                </div>
                            </div>
                        </form>
    ...
    <div style="height: 50px; background-color: #80da62; margin-top: 100px"></div>
                ...
                <div class="modal-body">
                    <div class="container form">
                        <form action="#" method="post" id="izmeniForm">
                            <h2 style="color: black; text-align: center; width: 500px;">Izmeni meč</h2>
                            <div class="row" style="color: black;">
                                <div class="col-md-12">
                                    <div class="form-group">

                                        <label for="mec-I">Odaberi meč</label>
                                ...
                                <div class="col-md-4">
                                    <br>
                                    <button id="btnIzmeni" type="button" class="btn btn-success btn-block" style="background-color: #80da62; border: 1px #80da62;" onclick="izmeniMec()">Izmeni</button>
                                    <br><br>
                                </div>
                            </div>
                        </form>
                ...
                <div class="modal-body">
                    <div class="container form">
                        <form action="#" method="post" id="obrisiForm">
                            <h2 style="color: black; text-align: center; width: 500px;">Obrisi meč</h2>
                            <div class="row" style="color: black;">
                                <div class="col-md-12">
                                    <div class="form-group">

                                        <label for="mec-O">Odaberi meč</label>
                                        <select name="mec-O" id="mec-O" style="border: 1px solid black" class="form-control"> </select>
                                    </div>
                                    <div class="col-md-4">
                                        <br>
                                        <button id="btnObrisi" type="button" class="btn btn-success btn-block" style="background-color: #80da62; border: 1px #80da62;" onclick="obrisiMec()">Obrisi</button>
                                        <br><br>
                                    </div>
                                </div>
                            </div>
