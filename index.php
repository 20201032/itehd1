...
<body>
    ...
    <div style="height: 50px; background-color: #80da62;"></div>
        ...
        <div class="main-div">
            <form method="post" action="">
                ...
                <div class="container" style="width: 30%; margin: auto;">
                    ...
                    <br>
                    <button type="submit" class="btn btn-primary" style="background-color: #80da62; border: 1px #80da62;" name="submit">Prijavi se</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div style="height: 100px; background-color: #80da62; margin-top:250px"></div>
